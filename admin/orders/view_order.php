<!--/* This is Admin (OrderList - Action View button) */-->
...
<div class="container-fluid">
    <!-- Outer Box for Order -->
    <div class="outer-box">
        <!-- Inner Box for Order Header -->
        <div class="inner-box">
            <h5>Order Information</h5>
            <div class="row">
                <div class="col-3"><strong>Reference Code:</strong></div>
                <div class="col-9 font-weight-bolder"><?= isset($code) ? $code : '' ?></div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-9 font-weight-bolder"><?= isset($delivery_address) ? $delivery_address : '' ?></div>
            </div>
            <div class="row">
                            ...
                            <div class="col-auto flex-shrink-1 flex-grow-1">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="col-auto px-0 flex-shrink-1 flex-grow-1">
                                        <p class="m-0 pl-3"><strong class="text-primary"><?= format_num($prow['price']) ?></strong></p>
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="col-auto px-0"><small class="text-muted">Quantity:</small></div>
                                    <div class="col-auto px-0 flex-shrink-1 flex-grow-1">
                                        <p class="m-0 pl-3"><strong class="text-primary"><?= format_num($prow['quantity']) ?></strong></p>
                                    </div>
                                </div>
                            </div>
                        </div>
