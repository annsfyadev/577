                ...
                <div class="callout callout-primary shadow rounded-0">
                    ...
                    <table class="table table-bordered table-stripped">
                        ...
                        <tbody>
                            ...
                            $i = 1;
                            $total = 0;
                            $orders = $conn->query("SELECT o.*,c.code as ccode, CONCAT(c.lastname, ', ',c.firstname,' ',COALESCE(c.middlename,'')) as customer from `order` o inner join customer c on o.customer_id = c.id where o.seller_id = '{$_settings->userdata('id')}' and date_format(o.date_created,'%Y-%m') = '{$month}' order by unix_timestamp(o.date_created) desc ");
