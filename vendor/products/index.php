				...
				<tbody>
					...
					?>
						<tr>
							...
							<td class="text-center align-middle"><?php echo date("Y-m-d H:i", strtotime($row['date_created'])); ?></td>
							<td class="text-center align-middle">
								<img src="<?= validate_image($row['image_path']) ?>" alt="Product Image" class="border border-gray img-thumbnail product-img">
							</td>
							<td class="align-middle"><?php echo $row['name']; ?></td>
							<td class="text-right align-middle"><?php echo format_num($row['price']); ?></td>
							<td class="text-center align-middle">
                                <?php if($row['status'] == 1): ?>
